...
export default function BusinessCreatePasswordStep() {
  const styles = createStyles(darkTheme);
  const { state, updateBusinessData, nextStep, previousStep, setErrors } = useSignupContext();
  ...
  const passwordStrength = calculatePasswordStrength(state.businessData.password);
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      nextStep();
      router.push('/(public)/signup-business/step-4');
    } catch {
            ...
            >
              <View style={styles.mainContent}>
                ...
                <View style={styles.formSection}>
                  <FloatingLabelInput
                    label="Password"
                    value={state.businessData.password}
                    ...
                    forceDarkTheme
                  />
                  {state.businessData.password.length > 0 && (
                  ...
                  <FloatingLabelInput
                    ...
                    value={state.businessData.confirmPassword}
                    ...
                    <View style={styles.requirementsFrame}>
                      ...
                      <View style={styles.requirementsList}>
                        <RequirementRow
                          ...
                          met={state.businessData.password.length >= 8}
                        ...
                        <RequirementRow
                          ...
                          textStyle={styles.requirementText}
                          textMetStyle={styles.requirementTextMet}
                          met={/[A-Z]/.test(state.businessData.password)}
                        ...
                        <RequirementRow
                          ...
                          textStyle={styles.requirementText}
                          textMetStyle={styles.requirementTextMet}
                          met={/\d/.test(state.businessData.password)}
                          text="One number"
                        />
                        <RequirementRow
                          rowStyle={styles.requirementRow}
                          textStyle={styles.requirementText}
                          textMetStyle={styles.requirementTextMet}
                          met={/[!@#$%^&*(),.?":{}|<>]/.test(state.businessData.password)}
