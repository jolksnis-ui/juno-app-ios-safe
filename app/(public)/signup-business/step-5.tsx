...
// Same Figma tokens as personal Account Purpose (step-4)
const FIGMA = {
...
// Same options as personal flow (Figma: Account Purpose)
...
export default function BusinessAccountPurposeStep() {
  const styles = createStyles();
  const { state, updateBusinessData, nextStep, previousStep, validateCurrentStep, resetState } = useSignupContext();
  ...
  const handleContinue = () => {
    ...
    nextStep();
    router.push('/(public)/signup-business/step-6');
  };
  ...
  const getSelectedPurposeLabel = () => {
    const selected = accountPurposeOptions.find((o) => o.value === state.businessData.businessPurpose);
  ...
  const renderDropdownItem = ({ item }: { item: SelectOption }) => (
    <TouchableOpacity
      ...
      onPress={() => {
        updateField('businessPurpose', item.value);
    ...
    >
      ...
      {state.businessData.businessPurpose === item.value && (
                ...
                <View style={styles.formSection}>
                  <View style={styles.countryInputWrapper}>
                    ...
                    >
                      <View style={styles.countrySelectorContent}>
                        {state.businessData.businessPurpose ? (
                          <>
                  ...
                  <View style={styles.textFieldBlock}>
                    ...
                    <TextInput
                      ...
                      value={state.businessData.fundFlowExplanation}
                  ...
                  <View style={styles.textFieldBlock}>
                    ...
                    <TextInput
                      ...
                      value={state.businessData.sourceOfFunds}
